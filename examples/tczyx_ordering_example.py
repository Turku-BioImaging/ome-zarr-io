...
def demonstrate_czyx_dimensions():
    ...
    print(f"Axes: {[ax.name for ax in axes]}")
    print(f"Scale: {scales}")
    print(f"Dimensions represent: C={axes[0].name}, Z={axes[1].name}, Y={axes[2].name}, X={axes[3].name}")
    print(f"Channel labels: {[ch.label for ch in channels]}")
    print("Valid TCZYX ordering: ✓")
...
def demonstrate_tzyx_dimensions():
    ...
    print(f"Axes: {[ax.name for ax in axes]}")
    print(f"Scale: {scales}")
    print(f"Dimensions represent: T={axes[0].name}, Z={axes[1].name}, Y={axes[2].name}, X={axes[3].name}")
    print("Valid TCZYX ordering: ✓")
...
def demonstrate_tcyx_dimensions():
    ...
    metadata = create_basic_metadata(axes, scales, "Live Fluorescence Time-lapse", channels)
    
    print(f"Axes: {[ax.name for ax in axes]}")
    print(f"Scale: {scales}")
    print(f"Dimensions represent: T={axes[0].name}, C={axes[1].name}, Y={axes[2].name}, X={axes[3].name}")
    print(f"Channel labels: {[ch.label for ch in channels]}")
    print("Valid TCZYX ordering: ✓")
...
def demonstrate_tczyx_dimensions():
    ...
    print(f"Axes: {[ax.name for ax in axes]}")
    print(f"Scale: {scales}")
    print(f"Dimensions represent: T={axes[0].name}, C={axes[1].name}, Z={axes[2].name}, Y={axes[3].name}, X={axes[4].name}")
    print(f"Channel labels: {[ch.label for ch in channels]}")
    print("Valid TCZYX ordering: ✓")
...
def demonstrate_invalid_orderings():
    ...
    for i, case in enumerate(invalid_cases, 1):
        ...
        try:
            ...
            axes = [Axis(name=name, type=type_name, unit="micrometer" if type_name == "space" else None) 
...
def main():
    ...
    print("=" * 80)
    print("Input images always follow TCZYX dimension order where T, C, Z are optional.")
    ...
    print("Summary")
    print("=" * 20)
    print(f"✓ Successfully created metadata for {len(metadata_results)} valid TCZYX dimension combinations")
