...
def create_czyx_metadata():
    ...
    scale_transform = create_scale_transformation([1.0, pixel_size_z, pixel_size_y, pixel_size_x])
...
def create_tcyx_metadata():
    ...
    scale_transform = create_scale_transformation([1.0, 1.0, pixel_size_y, pixel_size_x])
    ...
    # Create multiscale
    multiscale = Multiscale(
        name="Time-series Multichannel TCYX Image",
        datasets=[dataset],
        axes=axes
    )
