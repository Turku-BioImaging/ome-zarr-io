...
class TestTCZYXOrdering:
    ...
    def test_invalid_ordering_wrong_last_axes(self):
        ...
        with pytest.raises(ValueError, match="Last two axes must be Y, X in that order"):
            validate_tczyx_axis_ordering(axes)
    ...
    def test_invalid_axis_type(self):
        ...
        with pytest.raises(ValueError, match="Axis 't' should have type 'time', got 'space'"):
            validate_tczyx_axis_ordering(axes)
...
class TestTCZYXIntegration:
    ...
    def test_multiscale_validates_tczyx(self):
        ...
        from ome_zarr_writer.schema_models import Multiscale, Dataset, ScaleTransformation
